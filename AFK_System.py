...
class AFKSystem:
    ...
    def save_game_data(self, pocket_money, monster_hp, monster_max_hp, monster_name, monster_color, progression_index, stage, inventory_items=None, shop_items_state=None, pet_data=None, upgrade_level=0, guide_data=None):
        shop_state = []
        if shop_items_state:
    ...
    def load_and_calculate_afk_rewards(self):
        ...
        try:
            ...
            return afk_earnings, monster_data, saved_money, progression_index, stage, inventory, shop_state, pet_data, upgrade_level, guide_data
